  ...
  return (
    <main>
      <section className="bg-forest px-6 pb-20 pt-36 text-white md:px-[88px] md:pb-28 md:pt-48 fxl:px-[140px]">
        <p className="mb-4 text-[0.68rem] font-black uppercase tracking-[0.16em] text-white/60">Contatti</p>
        <h1 className="max-w-[980px] font-serif text-[clamp(3rem,6vw,6.8rem)] font-normal leading-[0.95] tracking-[-0.01em]">Inizia da una data, o da un desiderio.</h1>
        <p className="mt-6 max-w-[720px] text-base leading-7 text-white/72">
          Scrivici per organizzare un soggiorno a {siteConfig.locality}: una casa vacanza nel centro
          storico, una villa in affitto nelle campagne o un appartamento turistico vicino al mare.
        </p>
      </section>
      ...
      <section className="bg-ivory px-6 py-20 md:px-[88px] md:py-28 fxl:px-[140px] fxl:py-36">
        <div className="grid gap-10 md:grid-cols-[0.82fr_1.18fr]">
          <aside className="border-t border-ink/15 pt-7">
            <p className="mb-4 text-[0.68rem] font-black uppercase tracking-[0.16em] text-olive">Dati struttura</p>
            <h2 className="font-serif text-[clamp(2.2rem,4vw,4.5rem)] font-normal leading-[1]">{siteConfig.name}</h2>
      ...
      <section className="bg-paper px-6 pb-20 md:px-[88px] md:pb-28 fxl:px-[140px] fxl:pb-36">
        <div className="grid min-h-[420px] place-items-center bg-[linear-gradient(135deg,rgba(126,145,136,0.18),rgba(159,93,73,0.08)),repeating-linear-gradient(45deg,rgba(24,35,31,0.08)_0_1px,transparent_1px_22px)] p-8 text-center">
          <div>
            <p className="mb-4 text-[0.68rem] font-black uppercase tracking-[0.16em] text-olive">Mappa</p>
            <h2 className="font-serif text-[clamp(2.2rem,4vw,4.5rem)] font-normal leading-[1]">{siteConfig.mapLabel}</h2>
            <p className="mx-auto mt-5 max-w-[520px] text-muted">
              Placeholder leggero per integrare Google Maps, Mapbox o una mappa statica ottimizzata.
            </p>
          </div>
        </div>
      </section>
